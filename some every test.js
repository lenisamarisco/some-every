describe("#hasOddNumber", function() {
    it("returns true if there is at least one odd number in the array", function() {
      expect(hasOddNumber([1, 2, 3, 2, 2, 2, 4])).toEqual(true);
    });
  ...
  describe("#hasCertainKey", function() {
    ...
    it("returns true if every object in an array contains a certain key", function() {
        expect(hasCertainKey(arr, "title")).toEqual(true);
    });

    it("returns false if every object in an array does not contain a certain key", function() {
        expect(hasCertainKey(arr, "isCatOwner")).toEqual(false);
    });
});